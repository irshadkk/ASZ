...
//
var storeApp = angular.module('AngularStore', ['ngRoute', 'storeApp.config', 'favicon', 'igTruncate', 'slickCarousel']).
            ...
            createDialogService('',
                    {
                        ...
                        success: {label: 'Very Cool', fn: function() {
                                console.log('cart_display modal closed');
                            }}
                    });
        };
    }])
...
storeApp.config(['slickCarouselConfig', function(slickCarouselConfig) {
        slickCarouselConfig.dots = true;
        slickCarouselConfig.autoplay = false;
    }])
storeApp.controller('SlickController', function($scope, $timeout) {
    //====================================
    // Slick 1
    //====================================
